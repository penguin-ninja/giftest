...
function addLocalization(lang, locale, intlData) {
  addLocaleData(locale);
  localizationData[lang] = intlData;
  localizationData[lang].messages = flattenMessages(localizationData[lang].messages);
}
